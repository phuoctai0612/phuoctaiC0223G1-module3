...
<table border="1" width="800px" style="height: 400px" align="center">
    <tr>
        <th>Title</th>
        <th>Page_size</th>
        <th>Author_id</th>
...
<c:forEach items="${bookList}" var="book">
    <tr>
        ...
        <td><a href="/book?action=delete&id=${book.id}" onclick="deleteBook(${book.id},'${book.name}')">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="id" name="id">Sure</button>
            </div>
        </div>
    </div>
</div>
